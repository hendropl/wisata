    ...
    <View style={styles.container}>
      ...
      <View style={styles.toggleContainer}>
        <TouchableOpacity
          ...
          onPress={() => router.push('/login')} // Navigasi ke LoginScreen
        >
        ...
        >
          <Text style={[styles.toggleText, styles.activeText]}>Admin</Text>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push('/dashboard')} // Navigasi ke Dashboard
      >
